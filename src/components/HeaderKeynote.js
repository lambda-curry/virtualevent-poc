...
import styles from '../styles/header-keynote.module.scss'

class HeaderKeynote extends React.Component {
        ...
        <section className="hero">
          <div className={`columns`}>
            <div className={'column is-12'}>
              <div className={`${styles.body} hero-body`}>
                <span>
                  <b>NOA Sales & Marketing Annual Conference 2020</b>
                </span>
              </div>
            </div>
          </div>
...
export default connect(mapStateToProps)(HeaderKeynote);