...
import KeynotePage from "../templates/keynote-page"
    ...
    <Location>
      {({ location }) => (
        <Router basepath="/a" >
          ...
          <PrivateRoute path="/keynote/:eventId" summit_phase={summit_phase} component={KeynotePage} isLoggedIn={isLoggedUser} user={user} location={location} />
